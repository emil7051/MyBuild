...
def calculate_present_value(
    annual_amount: float, years: int, discount_rate: float = const.DISCOUNT_RATE
) -> float:
    """
...
def discount_to_present(
    amount: float, year: int, discount_rate: float = const.DISCOUNT_RATE
) -> float:
    """
...
def calculate_npv_of_payments(
    monthly_payment: float,
    num_payments: int,
    discount_rate: float = const.DISCOUNT_RATE,
) -> float:
    """
...
def calculate_npv_of_annual_cashflows(
    cashflows: List[float], discount_rate: float = const.DISCOUNT_RATE
) -> float:
    """
...
def calculate_annualised_cost(
    total_cost: float, years: int, discount_rate: float = const.DISCOUNT_RATE
) -> float:
    """
