...
ALL_MODELS: List[VehicleModel] = [
    ...
    VehicleModel('BEV004', 'DSL004', 'Medium Rigid', 'BEV', 'Volvo FL', 10.5, 200000.0, 300.0, 264.0, 0.88, 0.0, 130.0, 0.08, 653.0, 23000.0, 0.006),
    ...
    VehicleModel('BEV007', 'DSL007', 'Articulated', 'BEV', 'Volvo FH', 42.0, 450000.0, 300.0, 540.0, 1.8, 0.0, 130.0, 0.12, 6872.0, 84000.0, 0.009),
    VehicleModel('BEV008', 'DSL008', 'Articulated', 'BEV', 'Scania 45R', 42.0, 320000.0, 390.0, 624.0, 1.6, 0.0, 130.0, 0.12, 6872.0, 84000.0, 0.009),
