...
from calculations.utils import calculate_npv_of_payments, calculate_present_value
...
def generate_comparison_csv():
    ...
    for vehicle_id, inputs in all_inputs.items():
        ...
        total_insurance_pv = calculate_present_value(inputs.annual_insurance_cost, const.VEHICLE_LIFE)
        total_registration_pv = calculate_present_value(inputs.vehicle.annual_registration, const.VEHICLE_LIFE)
        ...
        capital_cost_per_km = calculate_annualised_cost(capital_cost_pv, const.VEHICLE_LIFE, const.DISCOUNT_RATE) / annual_kms
        ...
        insurance_per_km = calculate_annualised_cost(total_insurance_pv, const.VEHICLE_LIFE, const.DISCOUNT_RATE) / annual_kms
        registration_per_km = calculate_annualised_cost(total_registration_pv, const.VEHICLE_LIFE, const.DISCOUNT_RATE) / annual_kms
        carbon_per_km = calculate_annualised_cost(result.carbon_cost, const.VEHICLE_LIFE, const.DISCOUNT_RATE) / annual_kms
        battery_per_km = calculate_annualised_cost(result.battery_replacement_cost, const.VEHICLE_LIFE, const.DISCOUNT_RATE) / annual_kms
        penalties_per_km = calculate_annualised_cost(result.payload_penalty_cost + result.charging_labour_cost, const.VEHICLE_LIFE, const.DISCOUNT_RATE) / annual_kms
    ...
    column_order = [
        ...
        'total_tco_npv', 'annual_tco', 'cost_per_km_total',
        'cost_km_capital', 'cost_km_fuel', 'cost_km_maintenance', 
        'cost_km_insurance', 'cost_km_registration', 'cost_km_carbon', 'cost_km_battery', 'cost_km_penalties'
    ]
    df = df[column_order]
